  ...
  return (
    <div className="fixed top-0 left-0 right-0">
      ...
      >
        ...
        >
          <h1 className="pl-4 mb-4 h-[10vh] bg-black text-white flex items-center">
            <a href="#home">Lee Goullaud</a>
          </h1>
          <ul className="flex flex-col justify-start w-[100%] text-black">
            <li className="p-4 mx-2  border-b-2 border-gray-200 hover:scale-105 hover:duration-300 hover:ease-in-out ">
              <a href="#home">Home</a>
            </li>
            <li className="p-4 mx-2  border-b-2 border-gray-200 hover:scale-105 hover:duration-300 hover:ease-in-out ">
              <a href="#projects">Projects</a>
